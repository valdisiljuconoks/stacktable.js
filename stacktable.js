...
;(function($) {
 ...
 $.fn.stackcolumns = function(options) {
    ...
    return $tables.each(function() {
      ...
      if(typeof settings.column === 'undefined' && num_cols < 3) //stackcolumns has no effect on tables with less than 3 columns
        return;

      var $stackcolumns = $('<table class="stacktable small-only stackcolumns"></table>');
